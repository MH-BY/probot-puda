"""SMU+light machine for the probot platform (the ``smu-keysight-probot`` edge).
...
:class:`~probot_drivers.measurement_probot.MeasurementProbot` and expect
...
from .smu_keysight_probot import SMUKeysightProbot
from .pico_probot import PicoProbot
from .measurement_probot import MeasurementProbot, measurement_list
...
class SMUKeysightProbotMachine(MeasurementProbot):
    """The probot SMU+light machine: Keysight SMU + Pico light + measurements."""

    instrument_family = "smu_keysight_probot"
...
SMUKeysightProbotMachine.Keysight_Digital_Retention = MeasurementProbot.Keysight_Digital_Endurance
